...
var  flower,flower1,flower11,flower2,flower22,flower3,flower33;
...
function setup(){
  ...
  flower = createSprite(600,600,5,5);
  flower.addImage("flower",flower1);
  flower.scale = 0.2;

  flower2 = createSprite(300,300,5,5);
  flower2.addImage("flower2",flower1);
  flower2.scale = 0.2;

  flower3 = createSprite(700,200,5,5);
  flower3.addImage("flower3",flower1);
  flower3.scale = 0.2;

  flower4 = createSprite(100,100,5,5);
  flower4.addImage("flower4",flower1);
  flower4.scale = 0.2;

  flower5 = createSprite(1000,100,5,5);
  flower5.addImage("flower5",flower1);
  flower5.scale = 0.2;

  flower6 = createSprite(1000,300,5,5);
  flower6.addImage("flower6",flower1);
  flower6.scale = 0.2;

  flower7 = createSprite(100,550,5,5);
  flower7.addImage("flower7",flower1);
  flower7.scale = 0.2;

  flower8 = createSprite(900,550,5,5);
  flower8.addImage("flower8",flower1);
  flower8.scale = 0.2;
